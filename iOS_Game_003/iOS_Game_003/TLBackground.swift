...
class TLBackground: SKSpriteNode {
    ...
    func fctMoveLeft() {
        let actMoveLeft = SKAction.moveByX(-(size.height * ((flBackgroundRatio_001 * 5) + flBackgroundRatio_002 + flBackgroundRatio_003 + flBackgroundRatio_004 + flBackgroundRatio_005 + flBackgroundRatio_006)), y: 0, duration: 200.0)
