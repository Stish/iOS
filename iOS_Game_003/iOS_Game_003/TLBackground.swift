...
class TLBackground: SKSpriteNode {
    ...
    init(size: CGSize) {
        ...
        self.zPosition = 1.0
        // --- Part 001 ---
        let snBackground_001 = SKSpriteNode(texture: txBackground_001,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_001, height: size.height))
        snBackground_001.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        snBackground_001.position = CGPoint(x: 0, y: 0)
        addChild(snBackground_001)
        // --- Part 002 ---
        let snBackground_002 = SKSpriteNode(texture: txBackground_002,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_002, height: size.height))
        snBackground_002.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        snBackground_002.position = CGPoint(x: size.height * flBackgroundRatio_001, y: 0)
        addChild(snBackground_002)
        // --- Part 003 ---
        let snBackground_003 = SKSpriteNode(texture: txBackground_001,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_001, height: size.height))
        snBackground_003.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        snBackground_003.position = CGPoint(x: size.height * (flBackgroundRatio_001 + flBackgroundRatio_002), y: 0)
        addChild(snBackground_003)
        // --- Part 004 ---
        let snBackground_004 = SKSpriteNode(texture: txBackground_003,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_003, height: size.height))
        snBackground_004.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        ...
        // --- Part 005 ---
        let snBackground_005 = SKSpriteNode(texture: txBackground_001,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_001, height: size.height))
        snBackground_005.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        ...
        // --- Part 006 ---
        let snBackground_006 = SKSpriteNode(texture: txBackground_004,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_004, height: size.height))
        snBackground_006.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        ...
        // --- Part 007 ---
        let snBackground_007 = SKSpriteNode(texture: txBackground_001,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_001, height: size.height))
        snBackground_007.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        ...
        // --- Part 008 ---
        let snBackground_008 = SKSpriteNode(texture: txBackground_005,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_005, height: size.height))
        snBackground_008.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        ...
        // --- Part 009 ---
        let snBackground_009 = SKSpriteNode(texture: txBackground_001,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_001, height: size.height))
        snBackground_009.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        ...
        // --- Part 010 ---
        let snBackground_010 = SKSpriteNode(texture: txBackground_006,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_006, height: size.height))
        snBackground_010.anchorPoint = CGPoint(x: 0.0, y: 0.0)
        ...
        // --- Part 011 ---
        let snBackground_011 = SKSpriteNode(texture: txBackground_001,color: UIColor.black, size: CGSize(width: size.height * flBackgroundRatio_001, height: size.height))
        snBackground_011.anchorPoint = CGPoint(x: 0.0, y: 0.0)
    ...
    func fctMoveLeft() {
        let actMoveLeft = SKAction.moveBy(x: -(size.height * ((flBackgroundRatio_001 * 5) + flBackgroundRatio_002 + flBackgroundRatio_003 + flBackgroundRatio_004 + flBackgroundRatio_005 + flBackgroundRatio_006)), y: 0, duration: 400.0)
        let resetPosition = SKAction.moveTo(x: 0, duration: 0)
        let seqMoveLeft = SKAction.sequence([actMoveLeft, resetPosition])
        run(SKAction.repeatForever(seqMoveLeft))
    }
